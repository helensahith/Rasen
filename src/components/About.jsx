...
const About = () => {
  return (
    <div className='bg-black w-full h-screen text-white flex flex-col flex-nowrap justify-center items-center'>
      <div className='max-w-[1000px] w-full mb-2  grid grid-cols-2 gap-8'>
      ...
      <div className='max-w-[1000px] w-full py-3 sm:grid grid-cols-2 gap-5 justify-center items-center'>
        ...
        <p className='font_rw_200 sm:text-2xl  text-start  '>
